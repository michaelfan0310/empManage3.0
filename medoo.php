...
//   $sql="select password from user_admin where adminid=$usr";
...
// //       exit();
// //   }  else if( empty( $usr ) || empty( $psw ) ){
// //      header("Location:login.php?error=2&user=$usr&pswd=$psw");
// //      exit();
// //   }else {
// //       header("location: login.php?error=1&user=$usr&pswd=$psw");
// //   }
...
// //     $_SESSION['usrid'] = $usr;    //身份
// //     header("Location:emp_manage.php?usr=" . $usr);
// //     exit();
// //   }else{
// //     header("Location:login.php?error=1&usr=$usr&psw=$psw");
// //     exit();
// //   }
// ?>
